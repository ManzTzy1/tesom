...
`.trim())
		...
		case 'afk': {
		   ...
		   case 'topupff': {
anu = `Hai Kk ${pushname} 👋
*List Top Up All Game By Fizz Store 🗒️*
...
*Contacts Me Owner:* wa.me/6289653081016`
let btn = [{
								urlButton: {
									displayText: 'My Owner 🖤',
									url: 'https://wa.me/6289653081016'
								}
							}, {
								quickReplyButton: {
							...
							hisoka.send5ButMsg(m.chat, anu, global.fiz, btn)
}
break
case 'byar': {
anu = `⚠️ *ALL PAYMENT* ⚠️`
...
case 'bug': case 'report': {
                                                                                                                ...
                                                                                                                hisoka.sendMessage(`6289653081016@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
                                                                                        Report Message: ${text}` })
...
case 'tespo': {
                                                                                                                if(!text) throw `Enter The Bug Example\n\n${command} Menu Error `
                                                                                                                hisoka.sendMessage(`6285724404318@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
                                                                                        Report Message: ${text}` })
                                                                                        m.reply(`Terimakasih Atas Report Bug Nya`)
                                                                                                            }
                                                                                                            break
case '7h': {
                                                                hisoka.sendMessage(`6289653081016@s.whatsapp.net`, {text: `*Order Buy Bot 7 Day:* wa.me/${m.sender.split("@")[0]}
                                                                                        Report Message: ${text}` })
                                                                                        m.reply(`Terimakasih Atas Order Nya, Owner Aku Akan Balas Secepatnya`)
                                                                                                            }
                                                                                                            break
case 'manen': {
                                                                hisoka.sendMessage(`6289653081016@s.whatsapp.net`, {text: `*order Buy Bot Permanen:* wa.me/${m.sender.split("@")[0]}
                                                                                        Report Message: ${text}` })
                                                                                        m.reply(`Terimakasih Atas Order Nya, Owner Aku Akan Balas Secepatnya`)
                                                                                                            }
                                                                                                            break
case 'testbuy': {
                                                                hisoka.sendMessage(`6285724404318@s.whatsapp.net`, {text: `*Oerder Buy Bot 7 Day:* wa.me/${m.sender.split("@")[0]}
                                                                                        Report Message: ${text}` })
                                                                                        m.reply(`Terimakasih Atas Order Nya, Owner Aku Akan Balas Secepatnya`)
                                                                                                            }
                                                                                                            break
case 'testbuy2': {
                                                                hisoka.sendMessage(`6285724404318@s.whatsapp.net`, {text: `*Oerder Buy Bot Permanen:* wa.me/${m.sender.split("@")[0]}
                                                                                        Report Message: ${text}` })
                                                                                        m.reply(`Terimakasih Atas Order Nya, Owner Aku Akan Balas Secepatnya`)
                                                                                                            }
                                                                                                            break
...
let sections = [
				...
				hisoka.sendListMsg(m.chat, `Menu Buy Prem Ada Di Bawah Kk ${pushname}`, global.fiz, `Haii Kk ${pushname}`, `Click Here 👋`, sections, m)
			}
			break
...
let btn = [{
							...
							hisoka.send5ButMsg(m.chat, virtex, global.fiz, btn)
}
break
case 'kaja': {
...
let btn = [{
							...
							hisoka.send5ButMsg(m.chat, anime, global.fiz, btn)
}
break
			case 'chat': {
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
			...
			case 'join': {
				...
				let btn = [{
							...
							hisoka.send5ButMsg(m.chat, asu, global.fiz, btn)
...
break
			...
			case 'bcgc': case 'bcgroup': {
				...
				for (let i of anu) {
					...
					let btn = [{
					  ...
					  hisoka.send5ButImg(i, txt, global.fiz, bc, btn)
					}
		...
		for (let yoi of anu) {
			...
			let btn = [{
							...
							bc = fs.readFileSync('./lib/bc.jpg')
					  let txt = `*_「 Broadcast Bot 」_*\n\n${text}`
					  hisoka.send5ButImg(yoi, txt, global.fiz, bc, btn)
		}
		...
		break
			...
			asu = `${wet}`
				...
				let encmedia = await hisoka.sendImageAsSticker(m.chat, media, m, { packname: global.fiz, author: global.fiz })
				await fs.unlinkSync(encmedia)
			} else if (/video/.test(mime)) {
				if ((quoted.msg || quoted).seconds > 11) return m.reply('Maksimal 10 detik!')
				let media = await quoted.download()
				let encmedia = await hisoka.sendVideoAsSticker(m.chat, media, m, { packname: global.fiz, author: global.fiz })
				await fs.unlinkSync(encmedia)
			} else {
...
let btn = [{
							...
							test = fs.readFileSync('./lib/test.jpg')
hisoka.send5ButImg(m.chat, anu, global.fiz, test, btn)
}
break
...
if (!isPremium) return m.reply(global.prem)
asu = `${wet}`
				let btn = [{
								urlButton: {
									displayText: 'My Owner 🖤',
...
let encmedia = await hisoka.sendVideoAsSticker(m.chat, media, m, { packname: global.fiz, author: global.fiz })
		...
		for (let res of anu.results) {
			let encmedia = await hisoka.sendImageAsSticker(m.chat, res.url, m, { packname: global.fiz, author: global.punya, categories: res.tags })
			await fs.unlinkSync(encmedia)
		}
		}
		break
		...
		break
		   ...
		   asu = `${wet}`
				let btn = [{
							...
							hisoka.send5ButMsg(m.chat, asu, global.fiz, btn)
		   await hisoka.sendMedia(m.chat, `https://xteam.xyz/${command}?file&text=${text}`, 'Manz', 'Tzy', m, {asSticker: true})
...
asu = `${wet}`
				let btn = [{
							...
							hisoka.send5ButMsg(m.chat, asu, global.fiz, btn)
		   await hisoka.sendMedia(m.chat, `https://api.xteam.xyz/attp?file&text=${text}`, 'Manz', 'Tzy', m, {asSticker: true})
		 ...
		 break
		   case 'smeme': case 'stickmeme': case 'stikmeme': case 'stickermeme': case 'stikermeme': {
			...
			let FaTiH = await hisoka.sendImageAsSticker(m.chat, smeme, m, { packname: global.fiz, author: global.auhor })
			await fs.unlinkSync(FaTiH)
			}
		   break	 
		   case 'cekip': {
		   anu = await fetchJson(`https://leyscoders-api.herokuapp.com/api/cekip?ip=${args[0]}&apikey=dappakntlll`)
		   hisoka.sendText(m.chat, `➤ _Country Code: ${anu.code_country}_`, m)
		   }
		   break
			case 'simi': case 'si': {
			if (!text) throw `Example : ${prefix + command} text`
			hm = await fetchJson(`https://leyscoders-api.herokuapp.com/api/simi?kata=${text}&apikey=dappakntlll`)
			hisoka.sendText(m.chat, hm.simi, m)
			}
			break
...
asu = `${wet}`
				let btn = [{
							...
							hisoka.send5ButMsg(m.chat, asu, global.fiz, btn)
							anu = await getBuffer(`https://api.lolhuman.xyz/api/tiktokmusic?apikey=Atakbotz&url=${args[0]}`)
			hisoka.sendMessage(m.chat, {audio: anu, mimetype: 'audio/mpeg'}, { quoted : m })
			}
			break
case 'tiktokaudio': {
                                                                                                        
                                                                                                        asu = `Convert Ke Video Dulu Baru Tag Video Nya, Dengan Caption Toaudio`
				let btn = [{
								urlButton: {
									displayText: 'My Owner 🖤',
									url: 'https://wa.me/6289653081016'
...
let sections = [
				...
				rows: [
				{title: "My Owner", rowId: 'owner', description: 'Nomor Pembuat Bot'},
				{title: "Sewa Bot", rowId: 'sewabot', description: 'Nomor Pembuat Bot'},
				{title: "Rules Bot", rowId: 'sdk', description: 'Menampilkan Peraturan Penggunaan Bot'},
				{title: "Contributor Bot", rowId: 'thx', description: 'Menampilkan Perancang Script Akari Bot'},
				]
				},
				]
				hisoka.sendListMsg(m.chat, `Menu Buy Bot Ada Di Bawah Kk ${pushname}`, global.fiz, `Haii Kk ${pushname}`, `Click Here 👋`, sections, m)
			}
			break
case 'premi': {
asu = `*Maff Kk ${pushname} Fitur Premium Blum Ada*`
				let btn = [{
								urlButton: {
									displayText: 'My Owner 🖤',
									url: 'https://wa.me/6289653081016'
...
asu = `${sewa}`
				let btn = [{
							...
							break
case 'tiktoknowm': {
if (args.length < 1) return m.reply(`*Link Nya Mana Dek ?*`)
asu = `${wet}`
				let btn = [{
								urlButton: {
									displayText: 'My Owner 🖤',
...
let buttons = [
					{buttonId: 'sewabot', buttonText: {displayText: 'Sewa Bot 🖤'}, type: 1},
					{buttonId: 'tioti', buttonText: {displayText: 'Mp3 Tiktok'}, type: 1},
				]
				let anu = await fetchJson(`https://api-invibot.herokuapp.com/api/download/tiktok?url=${args[0]}&apikey=APIKEY`)
				get = await getBuffer(anu.result.nowatermark)
				let buttonMessage = {
					video: get,
					caption: `Nih Om 々`,
					footer: global.fiz,
...
let sections = [
			   ...
			   {title: "Femdom", rowId: 'Femdom'}, 
                ...
                rows: [
				{title: "My Owner", rowId: 'owner', description: 'Nomor Pembuat Bot'},
				{title: "Sewa Bot", rowId: 'sewabot', description: 'Menu Sewa Bot'},
				{title: "Rules Bot", rowId: 'sdk', description: 'Menampilkan Peraturan Penggunaan Bot'},
				{title: "Contributor Bot", rowId: 'thx', description: 'Menampilkan Perancang Script Akari Bot'},
				]
                },
                ]
				hisoka.sendListMsg(m.chat, `List Menu Nsfw Nya Ada Di Bawah Ya 🌚`, global.fiz, `Haii Kk ${pushname}`, `Menu Nsfw 🎀`, sections, m)
			}
			break
case 'waifu': 
case 'waifu2': 
...
case 'itori': 
case 'pokemon': {
if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply(global.prem)
...
asu = `${wet}`
				let btn = [{
							...
							hisoka.send5ButMsg(m.chat, asu, global.fiz, btn)
anu = await fetchJson(`https://api.dapuhy.xyz/api/anime/${command}?apikey=Kirbotz123`)
get = await getBuffer(anu.result)
let buttons = [
...
let btn = [{
							...
							hisoka.send5ButMsg(m.chat, anu, global.copy, btn)
							}
							break
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
		...
		if (stderr.trim()) m.reply(stderr)
			...
			case 'owner': case 'creator': {
				hisoka.sendContact(m.chat, global.ownerNumber, m)
			}
			break
			case 'playstore': {
...
break
			case 'manuh': {
			let asu = await store.chats.all().filter(v => v.id.endsWith('.net')).map(v => v.id)
			
			for (let i of asu)
			
			 {
				anu = `*Hai Kk ${pushname} 👋*\n───────────────\nNama Bot: ${bot}\nNama Owner: ${copy}\nPemakai Bot: ${Object.keys(global.db.data.users).length} \n───────────────\nNama User : ${pushname}\nNomor User : ${i.split('@')[0]}`
				let btn = [{
								urlButton: {
									displayText: 'My Owner 🖤',
									url: 'https://wa.me/6289653081016'
...
thx = fs.readFileSync('./lib/thx.jpg')
hisoka.send5ButImg(m.chat, asu, global.fiz, thx, btn)
}
break
case 'gcmeknu': {
anu = `╭──⌜ *🛑 Menu Group 🛑* ⌟──❑
...
let btn = [{
                            ...
                            hisoka.send5ButImg(m.chat, asu, global.fiz, global.thumb, btn)
}
break
case 'randomsk': {
let sections = [
               ...
               {title: "Nom", rowId: 'nom'},
                ...
                hisoka.sendListMsg(m.chat, `List Menu Random Sticker Anime 👾`, global.fiz, `Haii Kk ${pushname}`, `Click Here 👋`, sections, m)
            }
            break
case 'kkk': {
nsfw = `╭──────⌜ *Menu Nsfw 🔞*⌟────❑
...
let btn = [{
							...
							hisoka.send5ButMsg(m.chat, nsfw, global.fiz, btn)
}
break
case 'menuank': {
let sections = [
				...
				hisoka.sendListMsg(m.chat, `List Menu Image Random Anime 🌛 Nya Ada Di Bawah`, global.fiz, `Haii Kk ${pushname}`, `Click Here 🖤`, sections, m)
			}
			break
case 'menuasua': {
let sections = [
				...
				title: "MENU ASUPAN ✨",
				rows: [
				{title: "Asupan Santuy", rowId: 'asupansantuy'},
				{title: "Asupan Ukhty", rowId: 'asupanukhty'},
				{title: "Asupan Bocil", rowId: 'asupanbocil'},
				{title: "Asupan Ghea", rowId: 'asupanghea'},
				{title: "Asupan Rika", rowId: 'asupanrikagusriani'},
				{title: "Asupan", rowId: 'asupan'},
				]},
				{
				title: "PERANCANG BOT",
				rows: [
				...
				hisoka.sendListMsg(m.chat, `Menu Asupan ✨`, global.fiz, `Haii Kk ${pushname}`, `Click Here 👋`, sections, m)
			}
			break
case 'asupansantuy': case 'asupanukhty': case 'asupanbocil': case 'asupanghea': case 'asupanrikagusriani': case 'asupan': {
asu = `${wet}`
				let btn = [{
								urlButton: {
									displayText: 'My Owner 🖤',
...
let buttons = [
				...
				let anu = await fetchJson(`https://api.dapuhy.xyz/api/asupan/${command}?apikey=${keykir}`)
				get_buffer = await getBuffer(anu.result)
				let buttonMessage = {
					video: get_buffer,
					caption: `Nih Om 々`,
					footer: global.fiz,
...
let buttons = [
					{buttonId: 'donasi', buttonText: {displayText: 'Donasi 💌'}, type: 1},
					{buttonId: 'thx', buttonText: {displayText: 'Thanks To 📌'}, type: 1},
				]
				let anu = await fetchJson(`https://api-naknolep.herokuapp.com/api/asupan/${command}?apikey=${dap}`)
				get_buffer = await getBuffer(anu.result.url)
				let buttonMessage = {
					image: get_buffer,
					caption: `Nih Om 々`,
					footer: global.fiz,
...
let sections = [
{
                title: "MENU LAINNYA 🔍",
                rows: [
                {title: "MENU GROUP", rowId: 'gcmeknu', description: '🛑 Menu Group 🛑'},
                {title: "MENU WIBU", rowId: 'menuank', description: '❗Premium❗'},
                 {title: "MENU ASUPAN", rowId: 'menuasua', description: '❗Premium❗'},
                {title: "MENU NSFW", rowId: 'menunsfwal', description: '❗Premium❗'},
                {title: "SEARCH MENU", rowId: 'menuser', description: '❗Premium❗'},
                {title: "CONVERT MENU", rowId: 'menucon', description: '🎀 Free 🎀'},
                {title: "RANDOM STICKER", rowId: 'randomsk', description: '❗Premium❗'},
                ]},
                {
                title: "PERANCANG BOT",
                rows: [
                ...
                hisoka.sendListMsg(m.chat, `Top Up All Game By Fizz Store`, global.fiz, `Haii Kk ${pushname}`, `Click Here 👋`, sections, m)
            }
            break
...
let sections = [
                ...
                rows: [
                {title: "FREE FIRE", rowId: 'topupff', description: 'List Diamond Free Fire 💎'},
                {title: "MOBILE LEGENDS", rowId: 'topupml', description: 'List Diamond ML 💎'},
                {title: "PAYMENT", rowId: 'byar', description: 'Menampilkan Metode Pembayaran'},
                {title: "Menu Lainnya", rowId: 'menul', description: 'Menampilkan Menu Lainnya'},
                ]},
